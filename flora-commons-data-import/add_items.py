...
WI.wdi_core.WDItemEngine.core_props = { # https://github.com/SuLab/WikidataIntegrator/blob/master/wikidataintegrator/wdi_property_store.py
    'P6': {
        'datatype': 'string',
        'name': 'LJ Slug ID', 
...
if __name__ == "__main__":
    ...
    for row in csv_reader:
        ...
        try:
            ...
            wd_item = WI.wdi_core.WDItemEngine(new_item=True, data=data, mediawiki_api_url="http://localhost:8181/w/api.php")
            print(wd_item)
